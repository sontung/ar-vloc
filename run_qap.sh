cd libmpopt/qapopt/build/bin
qap_dd_greedy_gen --max-batches 10 --batch-size 1 --generate 1 --no-dummy /home/sontung/work/ar-vloc/qap/input.dd /home/sontung/work/ar-vloc/qap/proposal.txt
