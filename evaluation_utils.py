...
SFM_FOLDER = "/home/n11373598/work/nerf-vloc/data/7scenes_reference_models/7scenes_reference_models/fire/sfm_gt"
WS_FOLDER = pathlib.Path("7scenes_ws_div")
SFM_IMAGES_FILE = WS_FOLDER / "images.txt"  # from sfm models by using colmap to convert from bin to txt
QUERY_LIST = f"{SFM_FOLDER}/list_test.txt"
IMAGES_ROOT_FOLDER = pathlib.Path("/home/n11373598/work/nerf-vloc/data/fire")
